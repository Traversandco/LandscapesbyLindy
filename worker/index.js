...
const PRICES = {
  ...
  "paris-in-bloom":         { price: "price_1TyzBcBrZ8ulnngRJD4jW8Wk", product: "prod_Uxdv5OYwJpVlyw", name: "Paris in Bloom" },
  ...
  "the-curl":               { price: "price_1TyzCYBrZ8ulnngRBOykmDcq", product: "prod_Uxdvf03KzW2Jhn", name: "The Curl" },
  "muizenberg-beach-huts":  { price: "price_1Txie9BrZ8ulnngRTqCl3Ieh", product: "prod_UxdwvPchKiSTmN", name: "Beach Huts" },
  "beached":                { price: "price_1TyzH7BrZ8ulnngROQ2uqxWq", product: "prod_UxdwbQdOcroqPS", name: "Beached" },
  "turquoise-break":        { price: "price_1TyzDfBrZ8ulnngRphCzyJjS", product: "prod_UxdwLWwCvhudHV", name: "Turquoise Break" },
  "glass-wave":             { price: "price_1TyzD5BrZ8ulnngRbt3uhbpa", product: "prod_Uxdx2CtygXBe8B", name: "Glass Wave" },
  ...
  "little-donkey":          { price: "price_1TyzI6BrZ8ulnngRhy9kOWDr", product: "prod_UxdyABJGc1JWlI", name: "Little Donkey" },
  "provence-lavender-farm": { price: "price_1TyzAtBrZ8ulnngRzUSjbyyj", product: "prod_UxdufHZiBl2tZ4", name: "Provence Lavender Farm" },
